...
MODEL_PATH = "train_output_divided_to_turns_with_1_pass_to_20"
MODEL_MAX_SOURCE_LENGTH = 1024
OUTPUT_PATH_DIR = "predictions/t5_large_10_epochs_no_struct_beam_search/divided_to_turns_with_1_pass_to_20/"
VALIDATION_SET_PATH = "training_data/training_without_votes_divided_to_turns_with_1_pass_to_20_july_2023/validation_data.csv"
GAME_IDS = [
