...
def main():
    ...
    # target texts (unless you specify column names for this with the `input_column` and `target_column` arguments).
    #
    ...
    dataset_columns = column_name_mapping.get(data_args.dataset_name, None)
    if data_args.input_column is None:
        input_column = dataset_columns[0] if dataset_columns is not None else column_names[0]
    else:
