...
class T5MultitaskBystanderWithStructDataWithNamesAllConfig(DefaultConfig):
    def __init__(self):
        super().__init__(
            ...
            validation_file='training_data/training_by_all_data_with_structured_data_april_2023/validation_data_with_structured_data_without_votes_with_names.csv',
